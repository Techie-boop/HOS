...
import { updateHackathonAction } from "../../../../../actions/hackathon-actions";
...
interface EditHackathonPageFormProps {
  hackathon: {
    id: string;
    title: string;
    description: string;
...
export default function EditHackathonPageForm({ hackathon }: EditHackathonPageFormProps) {
  const [state, formAction, isPending] = useActionState(updateHackathonAction, null);
  ...
  const defaultStartDate = new Date(hackathon.startDate).toISOString().split("T")[0];
  const defaultEndDate = new Date(hackathon.endDate).toISOString().split("T")[0];
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 text-xs font-semibold">
        ...
        <div>
          ...
          <div className="mt-6 pt-6 border-t border-zinc-100">
            ...
            <input
              name="bannerUrl"
              type="url"
              defaultValue={hackathon.bannerUrl || ""}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div>
              ...
              <input
                name="locationLink"
                type="url"
                defaultValue={hackathon.locationLink || ""}
            ...
            <div>
              ...
              <input
                name="ticketingLink"
                type="url"
                defaultValue={hackathon.ticketingLink || ""}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 pt-4 border-t border-dashed border-zinc-150">
            <div>
              ...
              <input
                name="qrCodeUrl"
                type="url"
                defaultValue={hackathon.qrCodeUrl || ""}
      ...
      <div className="flex items-center justify-end gap-4 bg-white border border-zinc-200 rounded-lg p-4 shadow-sm">
        ...
        >
          {isPending ? "Saving changes..." : "Save Event Changes"}
        </button>
      </div>
